                ...
                isHidden ? "" :
                    <>
                        ...
                        <div className={"flex-col h-1/2 text-center flex justify-center items-center"}>
                            ...
                            <p className={` ${percent === 100 ? "visible" : "invisible"} mt-10 animate__animated animate__pulse animate__infinite text-white`}>
                                Nhấn vào đây để tiếp tục ...</p>
                        </div>
                    </>
            }
